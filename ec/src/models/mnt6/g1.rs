...
pub type G1Affine<P> = SWAffine<<P as MNT6Parameters>::G1Parameters>;
pub type G1Projective<P> = SWProjective<<P as MNT6Parameters>::G1Parameters>;
...
impl<P: MNT6Parameters> From<G1Projective<P>> for G1Prepared<P> {
