...
pub trait Fp6Config: 'static + Send + Sync {
    type Fp3Params: Fp3Config;

    const NONRESIDUE: Fp3<Self::Fp3Params>;

    /// Coefficients for the Frobenius automorphism.
    const FROBENIUS_COEFF_FP6_C1: &'static [<Self::Fp3Params as Fp3Config>::Fp];
    ...
    fn mul_fp3_by_nonresidue(fe: &Fp3<Self::Fp3Params>) -> Fp3<Self::Fp3Params> {
        ...
        res.c1 = fe.c0;
        res.c2 = fe.c1;
        res.c0 = <Self::Fp3Params as Fp3Config>::mul_fp_by_nonresidue(&res.c0);
        res
    }
}
...
impl<P: Fp6Config> QuadExtConfig for Fp6ParamsWrapper<P> {
    type BasePrimeField = <P::Fp3Params as Fp3Config>::Fp;
...
impl<P: Fp6Config> Fp6<P> {
    pub fn mul_by_034(
        &mut self,
        c0: &<P::Fp3Params as Fp3Config>::Fp,
        c3: &<P::Fp3Params as Fp3Config>::Fp,
        c4: &<P::Fp3Params as Fp3Config>::Fp,
    ) {
        let z0 = self.c0.c0;
        let z1 = self.c0.c1;
        let z2 = self.c0.c2;
        ...
        let mut tmp1 = x3;
        tmp1.mul_assign(&<P::Fp3Params as Fp3Config>::NONRESIDUE);
        let mut tmp2 = x4;
        tmp2.mul_assign(&<P::Fp3Params as Fp3Config>::NONRESIDUE);
    ...
    pub fn mul_by_014(
        &mut self,
        c0: &<P::Fp3Params as Fp3Config>::Fp,
        c1: &<P::Fp3Params as Fp3Config>::Fp,
        c4: &<P::Fp3Params as Fp3Config>::Fp,
    ) {
        let z0 = self.c0.c0;
        let z1 = self.c0.c1;
