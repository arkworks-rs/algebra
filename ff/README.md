...
- [`AdditiveGroup`](/ff/src/lib.rs) - Interface for additive groups that can is spanned by `Scalar`s. This applies both to prime-order fields, field extensions, and elliptic-curve groups used in cryptography.
