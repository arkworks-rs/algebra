...
- [`AdditiveGroup`](/ff/src/lib.rs) - Interface for additive groups that can be generated by a `ScalarField`. This applies both to prime-order fields, field extensions, and elliptic-curve groups used in cryptography.
