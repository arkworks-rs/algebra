...
- [\#423](https://github.com/arkworks-rs/algebra/pull/412) (`ark-ec`) Refactor `{FixedBase,VariableBase}::msm` methods to `fixed_base_msm` & `variable_base_msm` in `{Projective,Affine}Curve` traits.
