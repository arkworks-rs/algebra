...
use ark_ff::{
    biginteger::BigInteger832, AdditiveGroup, BigInt64, BitIteratorBE, CyclotomicMultSubgroup, Field,
    One,
};
...
pub const FINAL_EXPONENT_LAST_CHUNK_ABS_OF_W0: BigInteger832 = BigInt64!("7000705447348627246181409558336018323010329260726930841638672011287206690002601216854775649561085256265269640040570922609783227469279331691880282815325569032149343779036142830666859805506518426649197067288711084398033");

pub const FINAL_EXPONENT_LAST_CHUNK_W1: BigInteger832 = BigInt64!("86482221941698704497288378992285180119495364068003923046442785886272123124361700722982503222189455144364945735564951562986");
