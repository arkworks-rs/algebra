...
impl GLVConfig for VestaConfig {
    ...
    const SCALAR_DECOMP_COEFFS: [(bool, <Self::ScalarField as PrimeField>::BigInt); 4] = [
        (false, BigInt64!("98231058071100081932162823354453065729")),
        (true, BigInt64!("98231058071186745657228807397848383488")),
        (false, BigInt64!("196462116142286827589391630752301449217")),
        (false, BigInt64!("98231058071100081932162823354453065729")),
    ];
